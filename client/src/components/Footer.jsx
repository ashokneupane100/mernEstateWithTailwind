    ...
    <div className="bg-gradient-to-b from-gray-800 to-black text-white flex flex-col items-center px-1">
      <div className="flex flex-col items-center space-y-2 mb-4">
        <h3 className="text-2xl font-bold">
          Phone:{" "}
          <a href="tel:+9779851331644" className="bg-green-950 text-white-500 hover:underline">
            +977 9851 331644
          </a>
        </h3>
        <h5 className="text-base" style={{fontSize:"1.3rem"}}>Like us&nbsp;-&nbsp;Follow Us :</h5>
       ...
       <div style={{ marginBottom: "-3.5%", marginTop: "6%", fontSize: "1.2rem", backgroundColor: "blue", transition: "background-color 0.3s" }}>
